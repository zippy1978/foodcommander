...
var place = function(order, dryRun) {
    ...
    var sessionCookies = {};
    var streetId = 0;
    var stepProgress = 100 / (10 + order.lines.length);
                                ...
                                return Q.all(linePromises).then(function() {
                                    ...
                                    return checkCartContent(order, sessionCookies).then(function() {
                                        ...
                                        return validateOrder(order, sessionCookies).then(function() {
                                            ...
                                            return setDeliveryInfo(order, sessionCookies).then(function(orderConfirmation) {
 ...
 */
var setDeliveryInfo = function(order, cookies) {
